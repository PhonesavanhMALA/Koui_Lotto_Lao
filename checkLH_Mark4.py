...
def MarkThree():
    ...
    g_last_n_Charactor = g_Charactor[-4:]
    ...
    for i in range(g_length_of_charactors-numBer_WantsTo_check):
        ...
        c4 = g_Charactor[current_of_position - 3]
        ...
        if cb == g_last_n_Charactor:
            ...
            pc4 = current_of_position-1
            ### Mark3
            # index_to_markColor.extend([pc1,pc2,pc3])
            ### Mark4
            index_to_markColor.extend([pc4,pc1,pc2,pc3])
    ...
    if len(index_to_markColor) >= numBer_WantsTo_check:
        ...
        try:
            ...
            for elem in g_SumST:
                m_st += elem + "\n"
            with open('./282859/DRAW_GUIDE_Mark4.txt', mode="w") as lucky:
                lucky.write(f"THE RESULT OF MARK4 IS: \n{m_st}")
